...
while True:
    ...
    pick = input(
        'Please select your move ("rock", "scissors", "paper"): ').lower()
    ...
    system('cls')
    if winner == 'user':
        print(f"You won, congrats. Computer chose {
              moves[robotIndex]} while you {moves[pickIndex]}")
    else:
        print(f"Computer won, he chose {
              moves[robotIndex]} and you chose {moves[pickIndex]}")
    sleep(5)
